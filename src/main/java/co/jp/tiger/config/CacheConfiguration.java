...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, co.jp.tiger.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, co.jp.tiger.repository.UserRepository.USERS_BY_EMAIL_CACHE);
